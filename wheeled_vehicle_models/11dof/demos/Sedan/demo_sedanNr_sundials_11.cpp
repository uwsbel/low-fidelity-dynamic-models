...
int main(int argc, char** argv) {
    ...
    // std::string driver_file = "../../11dof/data/input/sedan_specific/" + std::string(argv[1]) + ".txt";
    ...
    // Enable output
    solver.SetOutput("../../11dof/data/output/" + std::string(argv[1]) + "_sedanNr11Sundials.csv");
