...
int main(int argc, char** argv) {
    ...
    std::string outputFileName = outputBasePath + argv[1] + "_sedanNr11Sundials.csv";
    ...
    std::string vehParamsJSON = "../../11dof/data/json/Sedan/vehicle.json";
    std::string tireParamsJSON = "../../11dof/data/json/Sedan/tmeasyNr.json";

    // Construct the solver
    d11SolverSundials solver;
    TireType type = TireType::TMeasyNr;  // Specific tire type without relaxation
