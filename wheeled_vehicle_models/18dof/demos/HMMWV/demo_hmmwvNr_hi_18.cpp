...
int main(int argc, char** argv) {
    ...
    std::string outputFileName = outputBasePath + argv[1] + "_hmmwvNr18Hi.csv";
    ...
    std::string tireParamsJSON = "../../18dof/data/json/HMMWV/tmeasyNr.json";

    // Construct the solver with TMeasyNr tire type
