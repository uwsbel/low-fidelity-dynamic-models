...
Once this is run, the `build` folder will be populated with the executables of the [demos](./18dof/demos) and the Python library (if `BUILD_PYTHON_MODULE` is set to `ON`).  
