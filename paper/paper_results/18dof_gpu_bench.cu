...
int main(int argc, char** argv) {
    ...
    std::string vehParamsJSON = (char*)"../../../wheeled_vehicle_models/18dof/data/json/HMMWV/vehicle.json";
    std::string tireParamsJSON = (char*)"../../../wheeled_vehicle_models/18dof/data/json/HMMWV/tmeasy.json";
