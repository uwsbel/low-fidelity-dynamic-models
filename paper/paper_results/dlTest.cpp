...
// =============================================================================
//
// Run with ./dlTest to reproduce data for the ISo Standard Double lange change maneuver case shown in paper
// To generate the plots run dlTestPlot.py
//
// =============================================================================
...
int main(int argc, char** argv) {
    ...
    std::string driver_file = "../../../wheeled_vehicle_models/18dof/data/input/iso_dl_10.txt";
    // =============================================================================
    // 11 DoF Model
    // =============================================================================
    ...
    // Enable output
    solver11.SetOutput("../data/LFDM/dl_sedan11Hi.csv", 100);
    solver11.Solve();
    ...
    // Enable output
    solver18.SetOutput("../data/LFDM/dl_sedan18Hi.csv", 100);
    solver18.Solve();
    ...
    solver24.SetOutput("../data/LFDM/dl_sedan24Hi.csv", 100);
    solver24.Solve();
}