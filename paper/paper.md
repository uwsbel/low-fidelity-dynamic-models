...
Further, the GPU version of the LFDMs enables large-scale parallel simulation, which comes into play in  Reinforcement Learning and traffic simulation. As shown in \autoref{fig:gpu_scale}, around 330,000 11DoF vehicle models can be simulated on an NVIDIA A100 GPU with an RTF of 1.
